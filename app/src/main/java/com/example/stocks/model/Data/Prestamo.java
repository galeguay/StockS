...
public class Prestamo extends Movimiento {
    ...
    public Prestamo(int idMovimiento, int codProducto, long fecha, int cantidad, String tipo, String socia) {
        super(idMovimiento, codProducto,fecha, cantidad);
        this.tipo = tipo;
        this.socia = socia;
    }

    public Prestamo(int codProducto, long fecha, int cantidad, String tipo, String socia) {
