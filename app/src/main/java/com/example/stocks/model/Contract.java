...
public class Contract {
    ...
    public static final String C_PERSONA = "persona"; //campo usado en los prestamos
    ...
    public static final String CREAR_TABLA_PRESTAMOS= "CREATE TABLE " + TABLA_PRESTAMOS +"("
            ...
            + C_CANTIDAD +" INTEGER, "
            + " FOREIGN KEY ("+C_ID_MOVIMIENTO+") REFERENCES "+TABLA_MOVIMIENTOS+"("+C_ID_MOVIMIENTO+"))";
    public static final String CREAR_TABLA_COLOR_LINEAS= "CREATE TABLE " + TABLA_LINEAS +"("
            + C_ID_PRODUCTO +" INTEGER PRIMARY KEY, "
            + C_NOMBRE +" TEXT)";
    public static final String CREAR_TABLA_MOVIMIENTOS= "create table " + TABLA_MOVIMIENTOS +"("
            + C_ID_MOVIMIENTO +" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " //int primary key autoincrement
